...
![](images/2023-02-08-17-00-50.png)

数据的基本操作为：**读(R)** 和 **写(W)** 两种

冲突的基本类型有：写后读 **RAW** 、读后写 **WAR** 以及写后写 **WAW**

上图给出了各类型对应的具体例子

##### 控制相关(控制冲突)

![控制相关](images/2023-02-08-17-06-42.png)

控制相关冲突是**由转移指令引起的**。当执行转移指令时，依据转移条件产生的结果，可能是顺序取下一条指令；也可能是转移到新的目标地址取指令，从而使流水线发生断流

#### 流水线的分类

![](images/2023-02-08-17-10-12.png)

![](images/2023-02-08-17-11-03.png)

这块内容了解就好

#### 流水线的多发技术

![](images/2023-02-08-17-12-29.png)

**超标量技术** ：在一个时钟周期内同时执行多条指令，需要给各个阶段指令的运行配备多个相应的功能部件

![](images/2023-02-08-17-15-30.png)

**超流水技术** ：同样，在一个时钟周期内执行多条指令，但是需要再分段，如图中 时间0~1这段时间内，三条指令的取指阶段再分段开始

![](images/2023-02-08-17-18-28.png)

**超长指令字** ：把能够并行操作的多条指令组合成一条